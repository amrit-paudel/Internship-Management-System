...
<div class="container-fluid">
    <div class="card">
      <div class="card-header">
        ...
        <a  class= "btn btn-sm btn-primary float-right" href="applicants.php?category=<?php echo $category?>&name=<?php echo $nameOfCompany?>&history=0"><i class="fa fa-eye" aria-hidden="true"></i>  View Applicants</a>
      </div>
      <div class="card-body">
